...
public class IconController : Singleton<IconController>
{
    ...
    public void ShowTriggerIcons(int icon_number)
    {
        ...
        switch (icon_number)
        {
            ...
            case 2:
                ...
                int currentEditingHistory = BubbleController.I.currentEditingHistory;
                int headEditingHistory = BubbleController.I.headEditingHistory;
                int tailEditingHistory = BubbleController.I.tailEditingHistory;
                int maxHistoryCount = BubbleController.I.maxHistoryCount;
    ...
    protected override void Awake()
    {
        ...
        blackDots = new RectTransform[BubbleController.I.maxHistoryCount - 2];
        ...
        for (int k = 1; k < BubbleController.I.maxHistoryCount - 2; k++)
        {
